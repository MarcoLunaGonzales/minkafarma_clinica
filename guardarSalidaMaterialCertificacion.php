...
$_COOKIE['global_usuario']=1001;
$_COOKIE['global_agencia']=2;
$_COOKIE['global_almacen']=1001;
...
do {
	...
	if($tipoDoc==1 || $tipoDoc==4){
		...
		$sql_insert="INSERT INTO `salida_almacenes`(`cod_salida_almacenes`, `cod_almacen`,`cod_tiposalida`, 
			...
			siat_cuis,siat_cuf,siat_codigotipodocumentoidentidad,siat_complemento,siat_codigoPuntoVenta,siat_excepcion,siat_codigocufd,siat_cod_leyenda, cod_pedido, nro_receta, nombre_paciente, nombre_medico)
		...
		$sql_inserta="INSERT INTO salida_almacenes(cod_salida_almacenes, cod_almacen, cod_tiposalida, 
 		...
 		cod_cliente, monto_total, descuento, monto_final, razon_social, nit, cod_chofer, cod_vehiculo, monto_cancelado, cod_dosificacion,cod_tipopago, monto_efectivo, monto_cambio, cod_pedido, nro_receta, nombre_paciente, nombre_medico)
 		values ('$codigo', '$almacenOrigen', '$tipoSalida', '$tipoDoc', '$fecha', '$hora', '0', '$almacenDestino', 
 		'$observaciones', '1', '$nro_correlativo', 0, '$codCliente', '$totalVenta', '$descuentoVenta', '$totalFinal', '$razonSocial', '$nitCliente', '$usuarioVendedor', '$vehiculo',0,'$cod_dosificacion','$tipoVenta','$totalEfectivo','$totalCambio', '$codPedido', '$ex_nro_receta', '$ex_nombre_paciente', '$ex_nombre_medico')";
 		//echo $sql_inserta;
