...
//	echo $sql;
	...
	echo "<tr class='textomini'>
		...
		<th>Hora</th>
		<th>Factura</th>
		<th>Observaciones<br>/Razón Social</th>
		<th class='bg-plomoclaro'>Ingresos</th>
		<th class='bg-plomoclaro'>Salidas</th>
		<th class='bg-plomoclaro'>Saldo</th>
		<th>Precio Venta</th>
	...
	{	
		...
		{	$nro_ingreso=$dat_ingresos[0];
		  ...
		  if($nro_origenSalida==''){
			...
			echo "<tr><td class='bg-plomoclaro'><b>$cod_ingreso_al</b></td><td class='bg-plomoclaro'>Ingreso</td><td align='left' class='bg-plomoclaro'>$nro_ingreso</td>
			<td align='center' class='bg-plomoclaro'>$fecha_consulta_format</td>
			<td align='center' class='bg-plomoclaro'>$horaIngreso</td>
      ...
      $razon_social=$dat_salidas['razon_social'];            
          ...
          $sqlResponsable="select CONCAT(SUBSTRING_INDEX(nombres,' ', 1),' ',SUBSTR(paterno, 1, 1),'.') from funcionarios where codigo_funcionario='".$codPersonalSalida."'";
			...
			echo "<tr><td class='bg-plomoclaro'><b>$cod_salida</b></td><td class='bg-plomoclaro'>Salida</td><td align='left' class='bg-plomoclaro'>$nro_salida</td>
					<td align='center' class='bg-plomoclaro'>$fecha_consulta_format</td>
					<td align='center' class='bg-plomoclaro'>$horaSalida</td>
			   <td class='bg-plomoclaro'>$nro_facturaProveedor</td>
			   <td>&nbsp;$obs_salida</td>
			   <td align='right'class=''>0</td>
