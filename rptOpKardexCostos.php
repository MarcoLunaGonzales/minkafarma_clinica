...
echo "<script language='JavaScript'>
		...
		{	var rpt_territorio, rpt_almacen,tipo_ingreso,fecha_ini, fecha_fin, tipo_item, rpt_item,rpt_tipo_impresion;
			...
			if(rpt_tipo_impresion==1){
				window.open('rptKardexCostos.php?rpt_territorio='+rpt_territorio+'&rpt_almacen='+rpt_almacen+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'&rpt_item='+rpt_item+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1200,height=800');
			}else{
...
echo "<h1>Reporte Kardex de Existencia Valorado</h1><br>";
