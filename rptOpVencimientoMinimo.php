...
echo"<form method='POST' action='rptVencimientoMinimo.php'  target='_blank'>";
	...
	echo "<tr><th align='left'>Stock a Fecha:</th>";
			echo" <TD bgcolor='#ffffff'>
			<INPUT  type='date' class='text' value='$fecha_rptdefault' id='rpt_ini' name='rpt_ini' readonly>
			</TD>";
	echo "</tr>";	

	echo "<tr><th align='left'>Ver Productos Vencidos De:</th>";
			echo" <TD bgcolor='#ffffff'>
			<INPUT  type='date' class='text' value='$fecha_rptdefault' id='rpt_vencimiento_ini' name='rpt_vencimiento_ini' required>
			</TD>";
	echo "</tr>";	

	echo "<tr><th align='left'>A:</th>";
			echo" <TD bgcolor='#ffffff'>
			<INPUT  type='date' class='text' value='$fecha_rptdefault' id='rpt_vencimiento_fin' name='rpt_vencimiento_fin' required>
			</TD>";
	echo "</tr>";	
