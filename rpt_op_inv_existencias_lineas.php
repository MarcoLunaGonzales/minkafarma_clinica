...
function cambiarSubLinea(){
  var categoria=$("#rpt_distribuidor").val();
...
echo"<form method='post' action='rpt_inv_existencias_lineas.php' target='_blank'>";
	...
	echo "<tr><th align='left'>Distribuidor</th><td>
		<select name='rpt_distribuidor[]' id='rpt_distribuidor' class='texto' multiple size='7' onChange='cambiarSubLinea();' required>";
	...
	<td><select name='rpt_linea[]' id='rpt_linea' class='texto' multiple size='6' data-style='btn btn-primary' data-actions-box='true' data-live-search='true'>";
	echo "</select></td></tr>";
