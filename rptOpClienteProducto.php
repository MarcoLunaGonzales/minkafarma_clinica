...
echo "<h1>Ventas x Cliente</h1>"; 

echo"<form method='POST' action='rptResumenClienteProducto.php'  target='_blank'>";
	...
	echo "<tr>
		...
		<td>
			<select name='rpt_tipo' id='rpt_tipo' class='selectpicker' data-style='btn btn-success' size='4'>
				<option value='1' selected>Resumen por Producto</option>
				<option value='2'>Resumen por Cliente</option>
			</select>
		</td>
	</tr>";
