...
$observacionesAjuste="";
if(isset($_POST["observaciones_ajuste"])){
    $observacionesAjuste=$_POST["observaciones_ajuste"];
}
...
if($idLineaProveedor!=0){
    ...
    $observaciones="Salida por Ajuste (Por busqueda de Item) ".$observacionesAjuste;
}
...
if($idLineaProveedor!=0){
    ...
    $observaciones="Ingreso por ajuste (Por Busqueda de Item). ".$observacionesAjuste;
}
