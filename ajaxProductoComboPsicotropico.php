...
$sql_item="SELECT m.codigo_material, m.descripcion_material,(SELECT nombre_proveedor from proveedores where cod_proveedor=(SELECT cod_proveedor from proveedores_lineas where cod_linea_proveedor=m.cod_linea_proveedor))proveedor 
			from material_apoyo m 
			where m.codigo_material <> 0 
			AND m.producto_controlado = '1' ";
