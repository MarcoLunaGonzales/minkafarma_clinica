		...
		if($rptOrdenar==1){
			if($rpt_ver==1){
				...
				ingreso_almacenes i, ingreso_detalle_almacenes id
					...
					m.codigo_material<>0 and p.cod_proveedor in ($array_proveedores) and m.estado='1' order by m.descripcion_material";
			}
		}else{
			if($rpt_ver==1){
				...
				i.ingreso_anulado=0 and i.cod_almacen='$rpt_almacen' and m.estado='1' and p.cod_proveedor in ($array_proveedores) order by 4,2";
			}			
		}
