...
<?php
    ...
    $pdf->Cell(5,$textypos,utf8_decode("Factura Nro.      ".$nroDocVenta));
    ...
    $pdf->Cell(5,$textypos,utf8_decode("(Con Derecho a Crédito Fiscal)"),0,0,'C');
    ...
    $pdf->Cell(5, $textypos,utf8_decode("PUNTO DE VENTA: ".$siat_codigopuntoventa));
    ...
    $pdf->Cell(5, $textypos,utf8_decode("CÓD. AUTORIZACIÓN:".$parte1), 0, 0,'R');
    $pdf->setY(25); $pdf->setX(190);
    $pdf->Cell(5, $textypos,utf8_decode($parte2), 0, 0,'R');
    ...
    $urlDir="";
    if($dat=mysqli_fetch_array($respDir)){
        $urlDir=$dat[0];
    }
    ...
    $x = $pdf->GetX();
    $pdf->SetFont('Arial', '', 7);
    $pdf->multiCell(190, 3, utf8_decode($txt2), 0, 'C', false);
