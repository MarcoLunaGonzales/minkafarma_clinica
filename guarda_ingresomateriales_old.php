...
cod_proveedor,created_by,modified_by,created_date,modified_date,descuento_adicional,descuento_adicional2,cod_tipopago,dias_credito,monto_ingreso,monto_cancelado,fecha_factura_proveedor,cod_tipo_doc) 
values($codigo,$global_almacen,$tipo_ingreso,'$fecha_real','$hora_sistema','$observaciones','0','$nota_entrega','$nro_correlativo',0,0,0,$nro_factura,0,0,'$proveedor','$createdBy','0','$createdDate','', '$descuentoAdicional','$descuentoTotal', '$cod_tipopago','$dias_credito','$monto_ingreso','$monto_cancelado','$fecha_factura_proveedor','$tipo_documento')";
...
if($sql_inserta==1){
	...
	/******************************************************/
	$queryMaestro = "SELECT i.nro_correlativo, i.cod_ingreso_almacen, i.nro_factura_proveedor, i.fecha, p.nombre_proveedor, 
			i.descuento_adicional, i.descuento_adicional2, i.fecha_factura_proveedor, 
				((SELECT ROUND(SUM((cantidad_unitaria * precio_bruto) - descuento_unitario), 2)
