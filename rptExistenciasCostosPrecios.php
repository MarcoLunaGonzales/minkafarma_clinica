...
$txt_reporte="Fecha de Reporte <strong>$fecha_reporte</strong>";
	...
	$nombre_almacen=$datos_nombre_almacen[0];
		...
		if($rptOrdenar==1){
			...
			<th>CantidadPresentacion</th><th>Cajas</th><th>Unidades</th><th>Costo Unitario (87%)</th><th>Costo</th></tr>
			</thead>";
		}
		...
		{	$codigo_item=$datos_item[0];
			...
			*/
			...
			{	//$cadena_mostrar.="<td align='center'>0</td></tr>";
				...
				//SACA EL ULITMO COSTO CORRECTO ANTES DE LA FECHA
				$precioUnitario=costoVentaFecha($enlaceCon,$codigo_item, $rpt_territorio, $rpt_fecha);
				/*SACAMOS EL COSTO AL 87%*/
